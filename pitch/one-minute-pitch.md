...
Community Spirit turns a residential community into a playable operating loop. POIs become places, routes become paths, activities become quests, and Community Pulse recommends the right real-space opportunity to the right resident based on interests, available time, social comfort, and walking distance.

In the demo, a basketball Pulse becomes a real task and route. The resident joins, checks in, earns XP and Spirit Points, unlocks a benefit pass, and contributes to a shared community goal. World Ops sees the same event as conversion, space activation, commerce, and retention: not only whether someone joined once, but whether residents come back.
